...
<!----- SLIDES START --->   	
	...
	<div id="slide2">
		<div class="content" align="center" >
 			<div id="loginheading"><h1> MANAGE YOUR AWESOME PROFILE! </h1>	</div>
        ...
        <div id="tabnavcontainer">
    		...
    		<ul class="tab-links">
        		...
        		<li class="activetab" id="tab2nav"><a href="manageprofile.php#loginheading"><img src="../icons/contact_card.png"/></a></li>
        		<li id="tab3nav"><a href="#tab3"><img src="../icons/favorites.png"/></a></li>
        		<li id="tab4nav"><a href="managepassword.php#loginheading"><img src="../icons/control_panel.png"/></a></li>
    		</ul>
			</div>
            </div>
 			<div id="userprofile">
